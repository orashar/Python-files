...
class mainApp(QWidget):
    ...
    def reviewList(self):
        ...
        self.proceedToDownloadButton = QPushButton("  Download Selected Item  ")
        self.proceedToDownloadButton.clicked.connect(self.proceedToDownload)
        self.proceedToDownloadAllButton = QPushButton("  Download All  ")
        self.proceedToDownloadAllButton.clicked.connect(self.addToQueue)

        self.reviewFrameMainLayout.addWidget(self.proceedToDownloadButton)
        self.reviewFrameMainLayout.addWidget(self.proceedToDownloadAllButton)

        self.reviewFrameMainLayout.setAlignment(Qt.AlignTop)
        self.reviewFrameMainLayout.addWidget(self.scrollArea)
    ...
    def addToQueue(self):
        ...
        if str(sender.text()) == "  Download All  ":
            self.filesLinkToDownload = self.storeRoom
            self.proceedToDownload()
        else:
    ...
    def downloadAll(self):
        self.filesLinkToDownload = self.storeRoom
        print(self.filesLinkToDownload)
        self.proceedToDownload()
